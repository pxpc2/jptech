import DarkWrapper from '@/components/wrappers/DarkWrapper';
  ...
  const features = [
    {
      ...
      desc: 'Entrega em todo o território brasileiro com agilidade.',
    },
    {
      icon: (
        <svg
      ...
      title: 'Transparência',
      desc: 'Facilidade e agilidade na comunicação com clientes e interessados',
    },
    {
      icon: (
        <svg
      ...
      title: 'Serviçpo de Garantia',
      desc: 'Se estende a todo o território nacional com atendimento on-site e remoto.',
    },
    {
      icon: (
        <svg
      ...
      title: 'Marcas Referência',
      desc: 'Maiores marcas do mercado, tendo como principal parceiro a Positivo.',
    },
  ];
  return (
    <DarkWrapper id="features" className="px-16 lg:px-24">
...
// logistica de frete, servico de garantia, transparencia, marcas referências
