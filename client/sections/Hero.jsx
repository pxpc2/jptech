...
export default function Hero() {
  return (
    <div className="bg-white h-[80vh] flex w-full align-middle items-center">
      {/* Hero card */}
        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
            ...
            <div className="relative px-8 py-28 sm:px-6 lg:px-8">
              ...
              >
                Abraçamos a missão de ser muito mais do que um simples provedor
                de tecnologia. Com uma dedicação incessante à inovação e
                excelência, estamos aqui para traduzir suas necessidades em
                soluções tangíveis e eficazes.
              </p>
